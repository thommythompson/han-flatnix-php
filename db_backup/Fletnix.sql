...
USE Fletnix
GO
CREATE LOGIN fletnix WITH PASSWORD = 'P@ssw0rd';
CREATE USER fletnix;
ALTER ROLE db_datareader ADD MEMBER fletnix;
ALTER ROLE db_datawriter ADD MEMBER fletnix;
ALTER DATABASE [Fletnix] SET MULTI_USER;
GO
SET ANSI_NULLS ON
GO
